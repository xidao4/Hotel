...
public class OrderController {
    ...
    @GetMapping("/{hotelId}/getOrderByHotelId")
    public ResponseVO getOrderByHotelId(@PathVariable int hotelId){
        return ResponseVO.buildSuccess(orderService.getOrderByHotelId(hotelId));
    }
