...
public interface HotelMapper {
    ...
    int update(@Param("id") int id, @Param("address") String address,@Param("phoneNum") String phoneNum,@Param("description") String description);
    ...
    int ex(@Param("id") int id,@Param("pic_1") String pic_1);
}
