...
|     orderbl      | po, vo                                          |
|      userbl      | po, vo                                          |
|   adminblImpl    | po, vo, adminbl, admindata, enums               |
|   couponblImpl   | po, vo, couponbl, coupondata                    |
|   hotelblImpl    | po, vo, hotelbl, userbl, hoteldata, util, enums |
|   orderblImpl    | hotelbl, orderbl, userbl, orderdata             |
|    userblImpl    | userbl, userdata, po, vo                        |
| admincontroller  | adminbl, vo                                     |
| couponcontroller | couponbl, vo                                    |
| hotelcontroller  | hotelbl,po, vo, util                            |
| ordercontroller  | orderbl, vo                                     |
|  usercontroller  | userbl, po, vo                                  |
|    admindata     | po                                              |
|    coupondata    | po                                              |
|    hoteldata     | po, vo                                          |
|    orderdata     | po                                              |
...
![](https://supernatural.oss-cn-beijing.aliyuncs.com/开发包图.png)
...
| 接口                                                         | 服务调用方 | 服务提供方 |
| ------------------------------------------------------------ | ---------- | ---------- |
| addOrder<br />getAllOrders<br />getUserOrders<br />annulOrder<br />getHotelOrders | 展示层     | 业务逻辑层 |
| addOrder<br />getAllOrders<br />getUserOrders<br />annulOrder<br />getOrderById | 业务逻辑层 | 数据层     |
